  ...
  const confirmOrderMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        ...
        description: "Ваш заказ отправлен на обработку",
      });
      setCart([]);
    ...
    <div className="container mx-auto py-6 px-4 max-w-4xl">
        ...
        <Card className="p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div>
              ...
              />
              <p className="text-xs text-muted-foreground mt-1">Минимум: {minTime}</p>
            </div>
            <div>
          ...
          <div className="border-t pt-4">
            ...
            <div className="flex gap-3">
              ...
              >
                {confirmOrderMutation.isPending ? "Отправка..." : "Подтвердить заказ"}
              </Button>
            </div>
          </div>
        </Card>
      ...
      {cart.length === 0 && orders.length === 0 && (
        <div className="text-center py-12">
          <p className="text-muted-foreground mb-4">У вас нет заказов</p>
            ...
            {orders.map((order) => (
              <Card key={order.id} className="p-4">
                <div className="flex justify-between items-start mb-3">
                  <div>
                    <p className="font-mono text-sm text-muted-foreground">Заказ #{order.id}</p>
                  ...
                  <div className="flex items-center gap-3">
                    {order.status === "confirmed" && apiClient.canCancelOrder(order.createdAt) && (
                      ...
                      >
                        ...
                        Отменить ({apiClient.getRemainingCancelTime(order.createdAt)} сек)
                      </Button>
                    )}
